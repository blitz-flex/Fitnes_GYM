...
class SettingsForm(FlaskForm):
    ...
    target_weight = StringField('Target Weight (kg)')
    ...
    workout_frequency = IntegerField('Workout Frequency (days/week)')
    ...
    sore_muscles = StringField('Sore Muscles') # Will be populated via JS
